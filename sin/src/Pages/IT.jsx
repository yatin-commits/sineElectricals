...
const IT = () => {
  ...
  return (
    <>
      <NavBar />
      <h1 className='text-4xl text-left px-4 my-4 underline'>IT: A Comprehensive Guide!</h1>

      {/* Flex container adjusted for responsiveness */}
      <div className="flex flex-col md:flex-row justify-center items-center gap-6 px-4">
        {/* Carousel */}
        <div className="w-full md:w-[40%]">
          <img src="./it.jpg" alt="IT System" />
        </div>
          ...
          <table className="table-auto border border-gray-300 w-full text-center">
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-gray-300 p-2">IT (Supervisory Control and Data Acquisition) systems monitor and control industrial processes from a central location.</td>
              </tr>
              <tr>
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-gray-300 p-2">
                  IT (Supervisory Control and Data Acquisition) systems monitor and control industrial processes from a central location.
                </td>
              </tr>
              <tr>
      ...
      <h1 className='font-[poppins] p-4 text-3xl'>IT: Detailed Description</h1>
      <p className='px-4'>
        IT systems are essential for industries such as manufacturing, power generation, water treatment, and transportation. They allow operators to monitor and control processes from a central location, enhancing efficiency, safety, and decision-making.
      </p>
      ...
      <div className='border-1 rounded-md border-black m-2'>
        ...
        <p className='px-4'>
          IT systems provide various features that optimize industrial processes:
        </p>
      ...
      <div className='border-1 rounded-md border-black m-2'>
        ...
        <p className='px-4'>
          IT systems are used across various industries to improve operations and efficiency:
        </p>
        <ul className="list-disc list-inside px-8">
      ...
      {/* Trends */}
      <div className='border-1 rounded-md border-black m-2'>
        <h2 className='font-[poppins] px-4 py-2 text-2xl'>Trends in IT Systems</h2>
        <p className='px-4'>
          Recent trends are shaping the future of IT systems:
        </p>
        <ul className="list-disc list-inside px-8">
