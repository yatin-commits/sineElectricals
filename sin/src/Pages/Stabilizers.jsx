...
const Stabilizers = () => {
  ...
  return (
    <>
      <NavBar />
      <h1 className='text-4xl text-left px-4 my-4 underline'>Stabilizers: A Comprehensive Guide!</h1>

      {/* Flex container adjusted for responsiveness */}
      <div className="flex flex-col md:flex-row justify-center items-center gap-6 px-4">
        {/* Carousel */}
        <div className="w-[50%] md:w-[40%]">
          <img src="./hand-tools.png" alt="" />
        </div>
      ...
      <h1 className='font-[poppins] p-4 text-3xl'>Stabilizers : Detailed Description</h1>
      <p className='px-4'>
